...
public class NS144_Activity extends Activity {
	int count=0;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_ns144_);
		Date start = new Date();
		String s = MyGlobalVariables.getData();
		s+="d144_start:"+start.toString()+";";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
            	...
            	if (u.length()!=0)
            	{
            		...
            		s+="d144_end:"+end.toString()+";";
            		MyGlobalVariables.setData(s);
            		Intent intent = new Intent(NS144_Activity.this, NS145_Activity.class);
            	...
            	else
            	{
            		...
            		MyGlobalVariables.setData(s);
					create_textfile();
            		Intent intent = new Intent(NS144_Activity.this, WordRecallAgain_Activity.class);
            	    startActivity(intent);
            	}
            }
        });
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.ns144_, menu);
		return true;
	}

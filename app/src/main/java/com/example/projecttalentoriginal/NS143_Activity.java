...
public class NS143_Activity extends Activity {
	int count=0;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_ns143_);
		Date start = new Date();
		String s = MyGlobalVariables.getData();
		s+="d143_start:"+start.toString()+";";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
            	...
            	String u=uid.getText().toString();
            	count++;
            	if (count==1 && u.length()==0) 
            	{
            		Toast msg = Toast.makeText(getBaseContext(), "YOU DID NOT ANSWER THE QUESTION",Toast.LENGTH_LONG);
            	    msg.show();
            	}
            	else if (count==2 && u.length()==0) 
            	{
            		Date end = new Date();
            		String s = MyGlobalVariables.getData();
            		s+="d143_end:"+end.toString()+";";
            		MyGlobalVariables.setData(s);
					create_textfile();
            		Intent intent = new Intent(NS143_Activity.this, WordRecallAgain_Activity.class);
            	...
            	else if (u.length()!=0)
            	{
            		...
            		s+="d143_end:"+end.toString()+";";
            		MyGlobalVariables.setData(s);
            		Intent intent = new Intent(NS143_Activity.this, NS144_Activity.class);
            	    startActivity(intent);
            	}
	...
	public void create_textfile()
	{
		...
		String fileName=f+ "/final_data_"+MyGlobalVariables.getUserName()+"_afterNumSubtract.txt";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.ns143_, menu);
		return true;
	}
	@Override

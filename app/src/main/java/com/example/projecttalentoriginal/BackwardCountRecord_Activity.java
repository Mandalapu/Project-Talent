...
public class BackwardCountRecord_Activity extends Activity {
	Handler handler;
 	//TextView tv;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_backward_count_record_);
		Date start = new Date();
		String s = MyGlobalVariables.getData();
		s+="d121_start:"+start.toString()+";";
		...
		fileName=f+ "/BC_"+MyGlobalVariables.getUserName()+timeStamp+".mp3";
        isRecording=false;
	}
	 public void startRecording(View view){
	    ...
	    public void stopRecording(){
	    	if(isRecording){
	    		...
	    		Date end = new Date();
        		String s = MyGlobalVariables.getData();
        		s+="d121_duration:20;d121_end:"+end.toString()+";";
        		MyGlobalVariables.setData(s);
	    		Intent intent = new Intent(BackwardCountRecord_Activity.this, WordRecall_Activity.class);
...
//	    	    tv.setVisibility(TextView.VISIBLE);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.backward_count_record_, menu);
		return true;
	}
	@Override

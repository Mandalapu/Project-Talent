...
public class NS145_Activity extends Activity {
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_ns145_);
		Date start = new Date();
		String s = MyGlobalVariables.getData();
		s+="d145_start:"+start.toString()+";";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
            	...
            	if (u.length()!=0)
            	{
            		...
            		s+="d145_end:"+end.toString()+";";
            		MyGlobalVariables.setData(s);
            		Intent intent = new Intent(NS145_Activity.this, NS146_Activity.class);
            	...
            	else
            	{
            		...
            		MyGlobalVariables.setData(s);
					create_textfile();
            		Intent intent = new Intent(NS145_Activity.this, WordRecallAgain_Activity.class);
            	    startActivity(intent);
            	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.ns145_, menu);
		return true;
	}
	@Override

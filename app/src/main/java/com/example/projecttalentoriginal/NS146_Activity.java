...
public class NS146_Activity extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_ns146_);
		Date start = new Date();
		String s = MyGlobalVariables.getData();
		s+="d146_start:"+start.toString()+";";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
            	...
            	if (u.length()!=0)
            	{
            		...
            		s+="d146_end:"+end.toString()+";";
            		MyGlobalVariables.setData(s);
					create_textfile();
            		Intent intent = new Intent(NS146_Activity.this, WordRecallAgain_Activity.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.ns146_, menu);
		return true;
	}
	@Override

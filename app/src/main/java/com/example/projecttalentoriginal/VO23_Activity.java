...
public class VO23_Activity extends ActionBarActivity {
    long ms;
    boolean click = false;
    boolean empty=false;
    int count=0;
        ...
        new CountDownTimer(60000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                else if(click && !empty)
                {
                    ...
                    Date end = new Date();String s = MyGlobalVariables.getTime();
...
//                    u = string.substring(string.length() - 1));
                ...
                if((click && count>=2)){
                    ...
                    MyGlobalVariables.setTime("");
                    Intent intent=null;
                    create_textfile(); intent = new Intent(VO23_Activity.this, SecNS_Activity.class);
                    startActivity(intent);
                }

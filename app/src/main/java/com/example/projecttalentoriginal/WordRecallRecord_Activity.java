...
public class WordRecallRecord_Activity extends Activity {
	Handler handler;
 	//TextView tv;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_word_recall_record_);
		Date start = new Date();
		String s = MyGlobalVariables.getData();
		s+="d106_start:"+start.toString()+";";
		...
		fileName=f+ "/IR_"+MyGlobalVariables.getUserName()+timeStamp+".mp3";
        isRecording=false;
	}
	 public void startRecording(View view){
	    ...
	    public void stopRecording(){
	    	if(isRecording){
	    		...
	    		Date end = new Date();
        		String s = MyGlobalVariables.getData();
        		s+="d106_duration:45;d106_end:"+end.toString()+";";
        		MyGlobalVariables.setData(s);
	    		Intent intent = new Intent(WordRecallRecord_Activity.this, SecSP_Activity.class);
...
//	    	    tv.setVisibility(TextView.VISIBLE);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.word_recall_record_, menu);
		return true;
	}
	@Override

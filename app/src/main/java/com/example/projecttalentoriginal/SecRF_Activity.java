...
public class SecRF_Activity extends Activity {
	Handler handler;
 	//TextView tv;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sec_rf_);
		Date start = new Date();
		String s = MyGlobalVariables.getData();
		s+="sec_rf_start:"+start.toString()+";";
		s+="rf101_start:"+start.toString()+";";
		...
		fileName=f+ "/FA_"+MyGlobalVariables.getUserName()+timeStamp+".mp3";
        isRecording=false;
	}
...
//	    	    tv.setVisibility(TextView.VISIBLE);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.sec_rf_, menu);
		return true;
	}
	@Override
